 ...
 */
public class Doctor_ViewProfile extends javax.swing.JFrame {

    /**
     * Creates new form Doctor_ViewProfile
     */
    ImageIcon i = new ImageIcon("hospital.jpg");
    JLabel l = new JLabel(i);
    public Doctor_ViewProfile() {
        setContentPane(l);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctor_ViewProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Doctor_ViewProfile().setVisible(true);
            }
        });
    }
